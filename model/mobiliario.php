...
class Mobiliario {
    ...
    public static function getMobiliario($salas){  
        ...
        $sql="SELECT m.numero_mobiliario, m.img_mobiliario, m.estado_mobiliario FROM tbl_mobiliario m INNER JOIN tbl_salas s ON m.id_sala=s.id where id_sala=$salas";  
